...
class GetLinodeConfigs200ResponseDataInnerDevicesSda(BaseModel):
    """
    ...
    """ # noqa: E501
    disk_id: Optional[StrictInt] = Field(default=None, description="The Disk ID, or `null` if a Volume is assigned to this slot.")
    volume_id: Optional[StrictInt] = Field(default=None, description="The Volume ID, or `null` if a Disk is assigned to this slot.")
    __properties: ClassVar[List[str]] = ["disk_id", "volume_id"]
