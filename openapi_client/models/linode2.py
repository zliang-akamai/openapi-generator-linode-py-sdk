...
class Linode2(BaseModel):
    ...
    placement_group: Optional[Linode1PlacementGroup] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "placement_group": Linode1PlacementGroup.from_dict(obj["placement_group"]) if obj.get("placement_group") is not None else None,
