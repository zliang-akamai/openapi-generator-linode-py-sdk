...
class GetLkeClusterAcl400Response(BaseModel):
    """
    GetLkeClusterAcl400Response
    """ # noqa: E501
    errors: Optional[List[GetLkeClusterAcl400ResponseErrorsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "errors": [GetLkeClusterAcl400ResponseErrorsInner.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj
