...
class AddedGetEntityTransfers200AllOfData(BaseModel):
    """
    ...
    entities: Optional[AddedGetEntityTransfers200AllOfEntities] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "entities": AddedGetEntityTransfers200AllOfEntities.from_dict(obj["entities"]) if obj.get("entities") is not None else None,
