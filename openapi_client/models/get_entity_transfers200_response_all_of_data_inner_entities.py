...
class GetEntityTransfers200ResponseAllOfDataInnerEntities(BaseModel):
    """
    A collection of the entities to include in this transfer request, separated by type.
    """ # noqa: E501
    linodes: Optional[List[StrictInt]] = Field(default=None, description="An array containing the IDs of each of the Linodes included in this transfer.")
    __properties: ClassVar[List[str]] = ["linodes"]
