...
class GetManagedContacts200ResponseDataInnerPhone(BaseModel):
    """
    Information about how to reach this Contact by phone.
    """ # noqa: E501
    primary: Optional[StrictStr] = Field(default=None, description="This Contact's primary phone number.")
    secondary: Optional[StrictStr] = Field(default=None, description="This Contact's secondary phone number.")
