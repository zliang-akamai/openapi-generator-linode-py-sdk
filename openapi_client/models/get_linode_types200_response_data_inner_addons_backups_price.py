...
class GetLinodeTypes200ResponseDataInnerAddonsBackupsPrice(BaseModel):
    """
    ...
    """ # noqa: E501
    hourly: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The cost (in US dollars) per hour to add Backups service.")
    monthly: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The cost (in US dollars) per month to add Backups service.")
