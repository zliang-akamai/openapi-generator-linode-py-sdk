...
class GetServiceTransfers200ResponseDataInner(BaseModel):
    """
    ...
    entities: Optional[GetServiceTransfers200ResponseDataInnerEntities] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "entities": GetServiceTransfers200ResponseDataInnerEntities.from_dict(obj["entities"]) if obj.get("entities") is not None else None,
