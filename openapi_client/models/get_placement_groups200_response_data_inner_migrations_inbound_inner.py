...
class GetPlacementGroups200ResponseDataInnerMigrationsInboundInner(BaseModel):
    """
    The individual compute instances the system is migrating into the placement group.
    """ # noqa: E501
    linode_id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a compute instance being migrated into the placement group.")
