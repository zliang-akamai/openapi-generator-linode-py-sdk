...
class GetDatabasesInstances200ResponseAllOfDataInner(BaseModel):
    """
    ...
    instance_uri: Optional[StrictStr] = Field(default=None, description="Append this to `https://api.linode.com` to run commands for the Managed Database.")
    ...
    __properties: ClassVar[List[str]] = ["allow_list", "cluster_size", "created", "encrypted", "engine", "hosts", "id", "instance_uri", "label", "region", "status", "type", "updated", "updates", "version"]
    ...
    def engine_validate_enum(cls, value):
        ...
        if value not in set(['mysql', 'postgresql']):
            raise ValueError("must be one of enum values ('mysql', 'postgresql')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "instance_uri": obj.get("instance_uri"),
            "label": obj.get("label"),
