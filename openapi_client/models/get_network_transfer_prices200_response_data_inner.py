...
class GetNetworkTransferPrices200ResponseDataInner(BaseModel):
    """
    Returns collection of network transfer prices, including any region-specific rates.
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The ID representing the network transfer price.")
    label: Optional[StrictStr] = Field(default=None, description="The network transfer price label is for display purposes only.")
    price: Optional[GetNetworkTransferPrices200ResponseDataInnerPrice] = None
    region_prices: Optional[List[GetNetworkTransferPrices200ResponseDataInnerRegionPricesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "label": obj.get("label"),
            "price": GetNetworkTransferPrices200ResponseDataInnerPrice.from_dict(obj["price"]) if obj.get("price") is not None else None,
            "region_prices": [GetNetworkTransferPrices200ResponseDataInnerRegionPricesInner.from_dict(_item) for _item in obj["region_prices"]] if obj.get("region_prices") is not None else None,
