...
class GetLkeClusterPools200ResponseDataInnerTaintsInner(BaseModel):
    """
    GetLkeClusterPools200ResponseDataInnerTaintsInner
    """ # noqa: E501
    effect: Optional[StrictStr] = Field(default=None, description="The Kubernetes taint effect. For `NoSchedule`, `PreferNoSchedule` and `NoExecute` descriptions, see [Kubernetes Taints and Tolerations](https://kubernetes.io/docs/concepts/scheduling-eviction/taint-and-toleration/).")
    key: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=63)]] = Field(default=None, description="The Kubernetes taint key.")
    value: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=63)]] = Field(default=None, description="The Kubernetes taint value.")
