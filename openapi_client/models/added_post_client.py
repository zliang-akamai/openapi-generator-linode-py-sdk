...
class AddedPostClient(BaseModel):
    """
    AddedPostClient
    """ # noqa: E501
    ...
    label: Annotated[str, Field(min_length=1, strict=True, max_length=512)] = Field(description="The name of this application.  This will be presented to users when they are asked to grant it access to their Account.")
    ...
    redirect_uri: StrictStr = Field(description="The location a successful log in from [login.linode.com](https://login.linode.com) should be redirected to for this client.  The receiver of this redirect should be ready to accept an OAuth exchange code and finish the OAuth exchange.")
