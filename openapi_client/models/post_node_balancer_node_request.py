...
class PostNodeBalancerNodeRequest(BaseModel):
    """
    PostNodeBalancerNodeRequest
    """ # noqa: E501
    address: StrictStr = Field(description="The private IP Address where this backend can be reached. This _must_ be a private IP address.")
    config_id: Optional[StrictInt] = Field(default=None, description="The NodeBalancer Config ID that this Node belongs to.")
    id: Optional[StrictInt] = Field(default=None, description="This node's unique ID.")
    label: Annotated[str, Field(min_length=3, strict=True, max_length=32)] = Field(description="The label for this node.  This is for display purposes only.")
    ...
    nodebalancer_id: Optional[StrictInt] = Field(default=None, description="The NodeBalancer ID that this Node belongs to.")
    status: Optional[StrictStr] = Field(default=None, description="The current status of this node, based on the configured checks of its NodeBalancer Config.")
    ...
    __properties: ClassVar[List[str]] = ["address", "config_id", "id", "label", "mode", "nodebalancer_id", "status", "weight"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['unknown', 'UP', 'DOWN']):
