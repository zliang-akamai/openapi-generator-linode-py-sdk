...
class PostUserRequest(BaseModel):
    ...
    PostUserRequest
    """ # noqa: E501
    email: StrictStr = Field(description="The email address for the User. Linode sends emails to this address for account management communications. May be used for other communications as configured.")
    last_login: Optional[GetUsers200ResponseDataInnerAllOfLastLogin] = None
    ...
    username: Annotated[str, Field(min_length=3, strict=True, max_length=32)] = Field(description="The User's username. This is used for logging in, and may also be displayed alongside actions the User performs (for example, in Events or public StackScripts).")
    ...
    __properties: ClassVar[List[str]] = ["email", "last_login", "password_created", "restricted", "ssh_keys", "tfa_enabled", "username", "verified_phone_number"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "email": obj.get("email"),
            "last_login": GetUsers200ResponseDataInnerAllOfLastLogin.from_dict(obj["last_login"]) if obj.get("last_login") is not None else None,
