...
class GetLinodeConfigs200ResponseDataInnerDevices(BaseModel):
    """
    ...
    sdh: Optional[GetLinodeConfigs200ResponseDataInnerDevicesSda] = None
    __properties: ClassVar[List[str]] = ["sda", "sdb", "sdc", "sdd", "sde", "sdf", "sdg", "sdh"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of sdh
        if self.sdh:
            _dict['sdh'] = self.sdh.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sdh": GetLinodeConfigs200ResponseDataInnerDevicesSda.from_dict(obj["sdh"]) if obj.get("sdh") is not None else None
        })
        return _obj
