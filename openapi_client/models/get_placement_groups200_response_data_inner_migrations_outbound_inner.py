...
class GetPlacementGroups200ResponseDataInnerMigrationsOutboundInner(BaseModel):
    """
    The individual compute instances the system is migrating out of the placement group.
    """ # noqa: E501
    linode_id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a compute instance being migrated out of the placement group.")
    __properties: ClassVar[List[str]] = ["linode_id"]
