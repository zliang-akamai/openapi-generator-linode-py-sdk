...
class GetLkeClusterApiEndpoints200ResponseDataInner(BaseModel):
    """
    GetLkeClusterApiEndpoints200ResponseDataInner
    """ # noqa: E501
    endpoint: Optional[StrictStr] = Field(default=None, description="A Kubernetes API server endpoint for this cluster.")
