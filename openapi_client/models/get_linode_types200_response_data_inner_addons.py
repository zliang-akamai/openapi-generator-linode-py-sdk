...
class GetLinodeTypes200ResponseDataInnerAddons(BaseModel):
    """
    A list of optional add-on services for Linodes and their associated costs.
    """ # noqa: E501
    backups: Optional[GetLinodeTypes200ResponseDataInnerAddonsBackups] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "backups": GetLinodeTypes200ResponseDataInnerAddonsBackups.from_dict(obj["backups"]) if obj.get("backups") is not None else None
        })
        return _obj
