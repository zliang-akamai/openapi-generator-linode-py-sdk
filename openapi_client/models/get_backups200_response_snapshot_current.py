...
class GetBackups200ResponseSnapshotCurrent(BaseModel):
    """
    ...
    type: Optional[StrictStr] = Field(default=None, description="This indicates whether the Backup is an automatic Backup or manual snapshot taken by the User at a specific point in time.")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['auto', 'snapshot']):
            raise ValueError("must be one of enum values ('auto', 'snapshot')")
        return value
