...
class GetLinodeTypes200ResponseDataInnerAddonsBackupsRegionPricesInner(BaseModel):
    """
    GetLinodeTypes200ResponseDataInnerAddonsBackupsRegionPricesInner
    """ # noqa: E501
    hourly: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Cost (in US dollars) per hour to add Backups service in this Region.")
    id: Optional[StrictStr] = Field(default=None, description="The Region ID for these prices.")
    monthly: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Cost (in US dollars) per month to add Backups service in this Region.")
