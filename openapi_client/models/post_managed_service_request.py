...
class PostManagedServiceRequest(BaseModel):
    """
    PostManagedServiceRequest
    """ # noqa: E501
    address: Annotated[str, Field(min_length=3, strict=True, max_length=100)] = Field(description="The URL at which this Service is monitored. URL parameters such as `?no-cache=1` are preserved. URL fragments/anchors such as `#monitor` are __not__ preserved.")
    ...
    label: Annotated[str, Field(min_length=3, strict=True, max_length=64)] = Field(description="The label for this Service. This is for display purposes only.")
    ...
    service_type: StrictStr = Field(description="How this Service is monitored.")
    status: Optional[StrictStr] = Field(default=None, description="The current status of this Service.")
    timeout: Annotated[int, Field(le=255, strict=True, ge=1)] = Field(description="How long to wait, in seconds, for a response before considering the Service to be down.")
