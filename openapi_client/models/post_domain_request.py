...
class PostDomainRequest(BaseModel):
    """
    PostDomainRequest
    """ # noqa: E501
    ...
    type: StrictStr = Field(description="Whether this Domain represents the authoritative source of information for the domain it describes (`master`), or whether it is a read-only copy of a master (`slave`).")
