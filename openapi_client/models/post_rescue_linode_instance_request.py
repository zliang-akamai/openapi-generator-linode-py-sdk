...
class PostRescueLinodeInstanceRequest(BaseModel):
    """
    PostRescueLinodeInstanceRequest
    """ # noqa: E501
    devices: Optional[PostRescueLinodeInstanceRequestDevices] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "devices": PostRescueLinodeInstanceRequestDevices.from_dict(obj["devices"]) if obj.get("devices") is not None else None
        })
        return _obj
