...
class GetDatabasesPostgreSqlInstances200ResponseAllOfDataInner(BaseModel):
    """
    ...
    hosts: Optional[GetDatabasesPostgreSqlInstances200ResponseAllOfDataInnerHosts] = None
    ...
    __properties: ClassVar[List[str]] = ["allow_list", "cluster_size", "created", "encrypted", "engine", "hosts", "id", "label", "port", "region", "replication_commit_type", "replication_type", "ssl_connection", "status", "total_disk_size_gb", "type", "updated", "updates", "used_disk_size_gb", "version"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hosts": GetDatabasesPostgreSqlInstances200ResponseAllOfDataInnerHosts.from_dict(obj["hosts"]) if obj.get("hosts") is not None else None,
            "id": obj.get("id"),
            "label": obj.get("label"),
            "port": obj.get("port"),
