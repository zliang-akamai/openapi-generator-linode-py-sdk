...
class GetLkeClusterKubeconfig200Response(BaseModel):
    """
    GetLkeClusterKubeconfig200Response
    """ # noqa: E501
    kubeconfig: Optional[StrictStr] = Field(default=None, description="The Base64-encoded Kubeconfig file for this Cluster.")
