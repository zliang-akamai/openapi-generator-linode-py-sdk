...
class GetLkeClusters200ResponseDataInner(BaseModel):
    """
    A Kubernetes cluster.
    """ # noqa: E501
    control_plane: Optional[GetLkeClusters200ResponseDataInnerControlPlane] = None
    created: Optional[datetime] = Field(default=None, description="When this Kubernetes cluster was created.")
    id: Optional[StrictInt] = Field(default=None, description="This Kubernetes cluster's unique ID.")
    k8s_version: Optional[StrictStr] = Field(default=None, description="The desired Kubernetes version for this Kubernetes cluster in the format of &lt;major&gt;.&lt;minor&gt;, and the latest supported patch version will be deployed.")
    ...
    region: Optional[StrictStr] = Field(default=None, description="This Kubernetes cluster's location.")
    ...
    updated: Optional[datetime] = Field(default=None, description="When this Kubernetes cluster was updated.")
    __properties: ClassVar[List[str]] = ["control_plane", "created", "id", "k8s_version", "label", "region", "tags", "updated"]
