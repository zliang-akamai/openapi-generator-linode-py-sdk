...
class PostNodeBalancerRequestConfigsInner(BaseModel):
    """
    ...
    nodes: List[PostNodeBalancerRequestConfigsInnerNodesInner] = Field(description="The NodeBalancer Nodes that serve this Config.")
    ...
    __properties: ClassVar[List[str]] = ["algorithm", "check", "check_attempts", "check_body", "check_interval", "check_passive", "check_path", "check_timeout", "cipher_suite", "nodes", "port", "protocol", "proxy_protocol", "ssl_cert", "ssl_key", "stickiness"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "nodes": [PostNodeBalancerRequestConfigsInnerNodesInner.from_dict(_item) for _item in obj["nodes"]] if obj.get("nodes") is not None else None,
