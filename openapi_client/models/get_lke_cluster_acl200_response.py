...
class GetLkeClusterAcl200Response(BaseModel):
    """
    GetLkeClusterAcl200Response
    """ # noqa: E501
    acl: Optional[GetLkeClusterAcl200ResponseAllOfAcl] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "acl": GetLkeClusterAcl200ResponseAllOfAcl.from_dict(obj["acl"]) if obj.get("acl") is not None else None
        })
        return _obj
