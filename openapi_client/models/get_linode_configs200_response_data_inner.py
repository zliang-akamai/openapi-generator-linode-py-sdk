...
class GetLinodeConfigs200ResponseDataInner(BaseModel):
    """
    ...
    devices: Optional[GetLinodeConfigs200ResponseDataInnerDevices] = None
    ...
    label: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=48)]] = Field(default=None, description="The Config's label is for display purposes only.")
