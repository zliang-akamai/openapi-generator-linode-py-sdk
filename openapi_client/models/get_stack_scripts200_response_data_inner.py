...
class GetStackScripts200ResponseDataInner(BaseModel):
    """
    ...
    images: Optional[List[StrictStr]] = Field(default=None, description="An array of Image IDs. These are the Images that can be deployed with this StackScript.  `any/all` indicates that all available Images, including private Images, are accepted.")
    ...
    label: Optional[Annotated[str, Field(min_length=3, strict=True, max_length=128)]] = Field(default=None, description="The StackScript's label is for display purposes only.")
    ...
    script: Optional[StrictStr] = Field(default=None, description="The script to execute when provisioning a new Linode with this StackScript.")
