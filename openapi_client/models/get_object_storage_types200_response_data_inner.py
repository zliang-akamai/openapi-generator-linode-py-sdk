...
class GetObjectStorageTypes200ResponseDataInner(BaseModel):
    """
    Returns collection of Object Storage types and prices, including any region-specific rates.
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The ID representing the Object Storage type.")
    label: Optional[StrictStr] = Field(default=None, description="The Object Storage type label is for display purposes only.")
    price: Optional[GetObjectStorageTypes200ResponseDataInnerPrice] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "label": obj.get("label"),
            "price": GetObjectStorageTypes200ResponseDataInnerPrice.from_dict(obj["price"]) if obj.get("price") is not None else None,
