...
class GetTaggedObjects200ResponseDataInner(BaseModel):
    """
    GetTaggedObjects200ResponseDataInner
    """ # noqa: E501
    data: Optional[GetTaggedObjects200ResponseDataInnerData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": GetTaggedObjects200ResponseDataInnerData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "type": obj.get("type")
        })
        return _obj
