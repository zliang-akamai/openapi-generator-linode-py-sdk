...
class GetUsers200ResponseDataInnerAllOfLastLogin(BaseModel):
    """
    ...
    """ # noqa: E501
    login_datetime: Optional[datetime] = Field(default=None, description="The date and time of this User's most recent login attempt.")
    status: Optional[StrictStr] = Field(default=None, description="The result of the most recent login attempt for this User.")
    __properties: ClassVar[List[str]] = ["login_datetime", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "login_datetime": obj.get("login_datetime"),
