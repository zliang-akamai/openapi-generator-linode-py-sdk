...
class GetSecurityQuestions200Response(BaseModel):
    """
    Security questions and responses object for GET operation.
    """ # noqa: E501
    security_questions: Optional[List[GetSecurityQuestions200ResponseSecurityQuestionsInner]] = Field(default=None, description="Security questions and response objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "security_questions": [GetSecurityQuestions200ResponseSecurityQuestionsInner.from_dict(_item) for _item in obj["security_questions"]] if obj.get("security_questions") is not None else None
        })
        return _obj
