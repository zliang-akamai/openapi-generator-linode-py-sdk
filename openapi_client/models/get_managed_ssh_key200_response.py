...
class GetManagedSshKey200Response(BaseModel):
    """
    A unique SSH public key that allows Linode's special forces to access a Managed server to respond to Issues.
    """ # noqa: E501
    ssh_key: Optional[StrictStr] = Field(default=None, description="The unique SSH public key assigned to your Linode account's Managed service.")
