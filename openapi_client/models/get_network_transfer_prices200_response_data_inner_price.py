...
class GetNetworkTransferPrices200ResponseDataInnerPrice(BaseModel):
    """
    ...
    """ # noqa: E501
    hourly: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Cost (in US dollars) per hour.")
    monthly: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Cost per month, in US dollars.")
