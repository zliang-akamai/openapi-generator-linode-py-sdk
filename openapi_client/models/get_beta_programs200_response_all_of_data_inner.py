...
class GetBetaPrograms200ResponseAllOfDataInner(BaseModel):
    """
    ...
    greenlight_only: Optional[StrictBool] = Field(default=None, description="Whether the Beta Program requires [Green Light](https://www.linode.com/green-light/) participation for enrollment.")
    ...
    more_info: Optional[StrictStr] = Field(default=None, description="Additional source of information for the Beta Program.")
    started: Optional[datetime] = Field(default=None, description="The start date-time of the Beta Program.")
    __properties: ClassVar[List[str]] = ["description", "ended", "greenlight_only", "id", "label", "more_info", "started"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if more_info (nullable) is None
        # and model_fields_set contains the field
        if self.more_info is None and "more_info" in self.model_fields_set:
            _dict['more_info'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ended": obj.get("ended"),
            "greenlight_only": obj.get("greenlight_only"),
            "id": obj.get("id"),
            "label": obj.get("label"),
