...
class GetDatabasesEngines200ResponseAllOfDataInner(BaseModel):
    """
    Managed Database engine object.
    """ # noqa: E501
    engine: Optional[StrictStr] = Field(default=None, description="The Managed Database engine type.")
    id: Optional[StrictStr] = Field(default=None, description="The Managed Database engine ID in engine/version format.")
    ...
    __properties: ClassVar[List[str]] = ["engine", "id", "total_disk_size_gb", "used_disk_size_gb", "version"]
