...
class GetNodeBalancerTypes200ResponseDataInner(BaseModel):
    """
    Returns collection of NodeBalancer types and prices, including any region-specific rates.
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The ID representing the NodeBalancer type.")
    label: Optional[StrictStr] = Field(default=None, description="The NodeBalancer type label is for display purposes only.")
    price: Optional[GetNodeBalancerTypes200ResponseDataInnerPrice] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "label": obj.get("label"),
            "price": GetNodeBalancerTypes200ResponseDataInnerPrice.from_dict(obj["price"]) if obj.get("price") is not None else None,
