...
class PostTicketReplyRequest(BaseModel):
    """
    PostTicketReplyRequest
    """ # noqa: E501
    description: Annotated[str, Field(min_length=1, strict=True, max_length=65535)] = Field(description="The content of your reply.")
