...
class GetPlacementGroups200ResponseDataInner(BaseModel):
    """
    ...
    migrations: Optional[GetPlacementGroups200ResponseDataInnerMigrations] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "is_compliant", "label", "members", "migrations", "placement_group_policy", "placement_group_type", "region"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "migrations": GetPlacementGroups200ResponseDataInnerMigrations.from_dict(obj["migrations"]) if obj.get("migrations") is not None else None,
