...
class GetIps200ResponseAllOfDataInner(BaseModel):
    """
    ...
    linode_id: Optional[StrictInt] = Field(default=None, description="The ID of the Linode this address currently belongs to. For IPv4 addresses, this defaults to the Linode that this address was assigned to on creation. IPv4 addresses may be moved using the [Assign IPv4s to Linodes](https://techdocs.akamai.com/linode-api/reference/post-assign-ipv4s) operation. For SLAAC and link-local addresses, this value may not be changed.")
    ...
    vpc_nat_1_1: Optional[GetIps200ResponseAllOfDataInnerVpcNat11] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "vpc_nat_1_1": GetIps200ResponseAllOfDataInnerVpcNat11.from_dict(obj["vpc_nat_1_1"]) if obj.get("vpc_nat_1_1") is not None else None
        })
        return _obj
