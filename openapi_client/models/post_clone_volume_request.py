...
class PostCloneVolumeRequest(BaseModel):
    """
    PostCloneVolumeRequest
    """ # noqa: E501
    label: Annotated[str, Field(min_length=1, strict=True, max_length=32)] = Field(description="The Volume's label is for display purposes only.")
