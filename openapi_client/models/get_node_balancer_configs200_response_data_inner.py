...
class GetNodeBalancerConfigs200ResponseDataInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["algorithm", "check", "check_attempts", "check_body", "check_interval", "check_passive", "check_path", "check_timeout", "cipher_suite", "id", "nodebalancer_id", "nodes_status", "port", "protocol", "proxy_protocol", "ssl_cert", "ssl_commonname", "ssl_fingerprint", "ssl_key", "stickiness"]
