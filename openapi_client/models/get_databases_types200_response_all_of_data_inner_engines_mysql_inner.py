...
class GetDatabasesTypes200ResponseAllOfDataInnerEnginesMysqlInner(BaseModel):
    """
    GetDatabasesTypes200ResponseAllOfDataInnerEnginesMysqlInner
    """ # noqa: E501
    price: Optional[GetDatabasesTypes200ResponseAllOfDataInnerEnginesMysqlInnerPrice] = None
    quantity: Optional[StrictInt] = Field(default=None, description="The number of nodes for the Managed Database cluster for this subscription tier.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "price": GetDatabasesTypes200ResponseAllOfDataInnerEnginesMysqlInnerPrice.from_dict(obj["price"]) if obj.get("price") is not None else None,
