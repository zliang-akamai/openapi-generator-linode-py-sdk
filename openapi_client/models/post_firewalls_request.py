...
class PostFirewallsRequest(BaseModel):
    """
    ...
    rules: PostFirewallsRequestAllOfRules
    ...
    devices: Optional[PostFirewallsRequestAllOfDevices] = None
    __properties: ClassVar[List[str]] = ["created", "id", "label", "rules", "status", "tags", "updated", "devices"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "label": obj.get("label"),
            "rules": PostFirewallsRequestAllOfRules.from_dict(obj["rules"]) if obj.get("rules") is not None else None,
            "status": obj.get("status"),
            "tags": obj.get("tags"),
            "updated": obj.get("updated"),
            "devices": PostFirewallsRequestAllOfDevices.from_dict(obj["devices"]) if obj.get("devices") is not None else None
        })
        return _obj
