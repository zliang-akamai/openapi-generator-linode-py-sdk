...
class NetworkTransferPricesApi:
    ...
    @validate_call
    def get_network_transfer_prices(
        self,
        ...
        _param = self._get_network_transfer_prices_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetNetworkTransferPrices200Response",
        }
    ...
    @validate_call
    def get_network_transfer_prices_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="__Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=1)] = 0,
    ) -> ApiResponse[GetNetworkTransferPrices200Response]:
        """List network transfer prices
    ...
    @validate_call
    def get_network_transfer_prices_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="__Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.")],
        _request_timeout: Union[
            None,
    ...
    def _get_network_transfer_prices_serialize(
        self,
        api_version,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{apiVersion}/network-transfer/prices',
