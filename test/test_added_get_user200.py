...
class TestAddedGetUser200(unittest.TestCase):
    """AddedGetUser200 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddedGetUser200:
        """Test AddedGetUser200
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddedGetUser200`
        """
        model = AddedGetUser200()
        if include_optional:
            return AddedGetUser200(
