...
class TestGetDatabasesPostgreSqlInstances200Response(unittest.TestCase):
    """GetDatabasesPostgreSqlInstances200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetDatabasesPostgreSqlInstances200Response:
        """Test GetDatabasesPostgreSqlInstances200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetDatabasesPostgreSqlInstances200Response`
        """
        model = GetDatabasesPostgreSqlInstances200Response()
        if include_optional:
            return GetDatabasesPostgreSqlInstances200Response(
                ...
                results = 1,
                data = [
                    openapi_client.models.get_databases_postgre_sql_instances_200_response_all_of_data_inner.get_databases_postgre_sql_instances_200_response_allOf_data_inner(
    ...
    def testGetDatabasesPostgreSqlInstances200Response(self):
        """Test GetDatabasesPostgreSqlInstances200Response"""
