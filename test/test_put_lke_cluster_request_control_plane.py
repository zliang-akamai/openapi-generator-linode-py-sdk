...
class TestPutLkeClusterRequestControlPlane(unittest.TestCase):
    """PutLkeClusterRequestControlPlane unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PutLkeClusterRequestControlPlane:
        """Test PutLkeClusterRequestControlPlane
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PutLkeClusterRequestControlPlane`
        """
        model = PutLkeClusterRequestControlPlane()
        if include_optional:
            return PutLkeClusterRequestControlPlane(
    ...
    def testPutLkeClusterRequestControlPlane(self):
        """Test PutLkeClusterRequestControlPlane"""
