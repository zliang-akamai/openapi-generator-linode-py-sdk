...
class TestGetLinodeConfigs200Response(unittest.TestCase):
    """GetLinodeConfigs200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLinodeConfigs200Response:
        """Test GetLinodeConfigs200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLinodeConfigs200Response`
        """
        model = GetLinodeConfigs200Response()
        if include_optional:
            return GetLinodeConfigs200Response(
                data = [
                    openapi_client.models.get_linode_configs_200_response_data_inner.get_linode_configs_200_response_data_inner(
    ...
    def testGetLinodeConfigs200Response(self):
        """Test GetLinodeConfigs200Response"""
