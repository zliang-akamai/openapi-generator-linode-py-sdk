...
class TestPutLkeNodePoolRequest(unittest.TestCase):
    """PutLkeNodePoolRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PutLkeNodePoolRequest:
        """Test PutLkeNodePoolRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PutLkeNodePoolRequest`
        """
        model = PutLkeNodePoolRequest()
        if include_optional:
    ...
    def testPutLkeNodePoolRequest(self):
        """Test PutLkeNodePoolRequest"""
