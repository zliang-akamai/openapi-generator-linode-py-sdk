...
class TestGetImages200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetImages200Response:
        """Test GetImages200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetImages200Response`
        """
        model = GetImages200Response()
        if include_optional:
            return GetImages200Response(
                data = [
                    openapi_client.models.get_images_200_response_data_inner.get_images_200_response_data_inner(
