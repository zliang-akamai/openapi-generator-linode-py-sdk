...
class TestGetNotifications200ResponseDataInner(unittest.TestCase):
    """GetNotifications200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetNotifications200ResponseDataInner:
        """Test GetNotifications200ResponseDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetNotifications200ResponseDataInner`
        """
        model = GetNotifications200ResponseDataInner()
        if include_optional:
            return GetNotifications200ResponseDataInner(
                body = '',
    ...
    def testGetNotifications200ResponseDataInner(self):
        """Test GetNotifications200ResponseDataInner"""
