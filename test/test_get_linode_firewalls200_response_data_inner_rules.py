...
class TestGetLinodeFirewalls200ResponseDataInnerRules(unittest.TestCase):
    """GetLinodeFirewalls200ResponseDataInnerRules unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLinodeFirewalls200ResponseDataInnerRules:
        """Test GetLinodeFirewalls200ResponseDataInnerRules
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLinodeFirewalls200ResponseDataInnerRules`
        """
        model = GetLinodeFirewalls200ResponseDataInnerRules()
        if include_optional:
    ...
    def testGetLinodeFirewalls200ResponseDataInnerRules(self):
        """Test GetLinodeFirewalls200ResponseDataInnerRules"""
