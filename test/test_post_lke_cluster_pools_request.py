...
class TestPostLkeClusterPoolsRequest(unittest.TestCase):
    """PostLkeClusterPoolsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostLkeClusterPoolsRequest:
        """Test PostLkeClusterPoolsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostLkeClusterPoolsRequest`
        """
        model = PostLkeClusterPoolsRequest()
        if include_optional:
    ...
    def testPostLkeClusterPoolsRequest(self):
        """Test PostLkeClusterPoolsRequest"""
