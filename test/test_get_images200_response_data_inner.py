...
class TestGetImages200ResponseDataInner(unittest.TestCase):
    """GetImages200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetImages200ResponseDataInner:
        """Test GetImages200ResponseDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetImages200ResponseDataInner`
        """
        model = GetImages200ResponseDataInner()
        if include_optional:
    ...
    def testGetImages200ResponseDataInner(self):
        """Test GetImages200ResponseDataInner"""
