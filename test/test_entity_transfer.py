...
class TestEntityTransfer(unittest.TestCase):
    """EntityTransfer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EntityTransfer:
        """Test EntityTransfer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EntityTransfer`
        """
        model = EntityTransfer()
        if include_optional:
