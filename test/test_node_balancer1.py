...
class TestNodeBalancer1(unittest.TestCase):
    """NodeBalancer1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NodeBalancer1:
        """Test NodeBalancer1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NodeBalancer1`
        """
        model = NodeBalancer1()
        if include_optional:
