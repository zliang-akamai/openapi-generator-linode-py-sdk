...
class TestGetDatabasesMysqlInstances200ResponseAllOfDataInner(unittest.TestCase):
    """GetDatabasesMysqlInstances200ResponseAllOfDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetDatabasesMysqlInstances200ResponseAllOfDataInner:
        """Test GetDatabasesMysqlInstances200ResponseAllOfDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetDatabasesMysqlInstances200ResponseAllOfDataInner`
        """
        model = GetDatabasesMysqlInstances200ResponseAllOfDataInner()
        if include_optional:
    ...
    def testGetDatabasesMysqlInstances200ResponseAllOfDataInner(self):
        """Test GetDatabasesMysqlInstances200ResponseAllOfDataInner"""
