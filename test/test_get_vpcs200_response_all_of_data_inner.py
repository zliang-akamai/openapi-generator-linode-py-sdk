...
class TestGetVpcs200ResponseAllOfDataInner(unittest.TestCase):
    """GetVpcs200ResponseAllOfDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetVpcs200ResponseAllOfDataInner:
        """Test GetVpcs200ResponseAllOfDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVpcs200ResponseAllOfDataInner`
        """
        model = GetVpcs200ResponseAllOfDataInner()
        if include_optional:
    ...
    def testGetVpcs200ResponseAllOfDataInner(self):
        """Test GetVpcs200ResponseAllOfDataInner"""
