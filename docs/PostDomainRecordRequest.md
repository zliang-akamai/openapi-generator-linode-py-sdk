...
json = "{}"
# create an instance of PostDomainRecordRequest from a JSON string
post_domain_record_request_instance = PostDomainRecordRequest.from_json(json)
# print the JSON string representation of the object
print(PostDomainRecordRequest.to_json())

# convert the object into a dict
post_domain_record_request_dict = post_domain_record_request_instance.to_dict()
# create an instance of PostDomainRecordRequest from a dict
post_domain_record_request_from_dict = PostDomainRecordRequest.from_dict(post_domain_record_request_dict)
```
