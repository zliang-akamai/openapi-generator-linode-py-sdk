...
json = "{}"
# create an instance of PutDomainRecordRequest from a JSON string
put_domain_record_request_instance = PutDomainRecordRequest.from_json(json)
# print the JSON string representation of the object
print(PutDomainRecordRequest.to_json())

# convert the object into a dict
put_domain_record_request_dict = put_domain_record_request_instance.to_dict()
# create an instance of PutDomainRecordRequest from a dict
put_domain_record_request_from_dict = PutDomainRecordRequest.from_dict(put_domain_record_request_dict)
```
