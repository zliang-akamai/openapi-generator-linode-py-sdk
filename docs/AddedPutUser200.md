...
added_put_user200_instance = AddedPutUser200.from_json(json)
# print the JSON string representation of the object
print(AddedPutUser200.to_json())

# convert the object into a dict
added_put_user200_dict = added_put_user200_instance.to_dict()
# create an instance of AddedPutUser200 from a dict
added_put_user200_from_dict = AddedPutUser200.from_dict(added_put_user200_dict)
```
