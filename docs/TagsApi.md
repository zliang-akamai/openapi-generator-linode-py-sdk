...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    tag_label = 'tag_label_example' # str | 

    try:
        # Delete a tag
        api_response = api_instance.delete_ag(api_version, tag_label)
        print("The response of TagsApi->delete_ag:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TagsApi->delete_ag: %s\n" % e)
```
...
# **get_tagged_objects**
> GetTaggedObjects200Response get_tagged_objects(api_version, tag_label, page=page, page_size=page_size)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List tagged objects
        api_response = api_instance.get_tagged_objects(api_version, tag_label, page=page, page_size=page_size)
        print("The response of TagsApi->get_tagged_objects:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TagsApi->get_tagged_objects: %s\n" % e)
```
...
# **get_tags**
> GetTags200Response get_tags(api_version, page=page, page_size=page_size)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List tags
        api_response = api_instance.get_tags(api_version, page=page, page_size=page_size)
...
# **post_tag**
> GetTags200ResponseDataInner post_tag(api_version, post_tag_request=post_tag_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.TagsApi(api_client)
    api_version = v4 # str | __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta. (default to v4)
    post_tag_request = openapi_client.PostTagRequest() # PostTagRequest | The tag to create, and optionally the objects to tag. (optional)

    try:
        # Create a tag
        api_response = api_instance.post_tag(api_version, post_tag_request=post_tag_request)
        print("The response of TagsApi->post_tag:\n")
        pprint(api_response)
    except Exception as e:
